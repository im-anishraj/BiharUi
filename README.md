...
<div align="center">
  <img src="src/assets/common/readme-showcase.png" alt="BiharUI component showcase" width="1000">
</div>
...
BiharUI helps you **ship stunning interfaces faster**. Instead of spending hours crafting animations from scratch, grab a polished component and customize it to fit your vision.
...
<div align="center">
  <img src="src/assets/common/tools-readme.webp" alt="BiharUI Tools" width="1000" style="border-radius: 30px; max-width: 1920px;">
</div>

<hr />

### Beyond components, BiharUI offers **free creative tools** to supercharge your workflow:
...
BiharUI supports [shadcn](https://ui.shadcn.com/) and [jsrepo](https://jsrepo.dev) for quick CLI installs.
...
BiharUI is proudly supported by these amazing sponsors:
