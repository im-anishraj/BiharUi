...
const INTRO_LINES = [
  'BiharUI is an open source collection of memorable UI elements - Components, Animations, Backgrounds, and Text Animations - provided in four implementation variants: JavaScript + CSS, JavaScript + Tailwind, TypeScript + CSS, and TypeScript + Tailwind.',
...
const MCP_LINKS = [
  {
    label: 'MCP Setup',
    url: 'https://www.reactbits.dev/get-started/mcp',
    note: 'How AI agents can browse/search BiharUI.'
  },
