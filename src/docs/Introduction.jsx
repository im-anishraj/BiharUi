  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph dim">
        BiharUI is an open-source collection of carefully designed UI components that aim to enhance your React web
        applications.
      </p>
      ...
      <p className="docs-paragraph dim">
        The goal of BiharUI is simple - provide flexible, visually stunning and most importantly, free components that
        take web projects to the next level.
      </p>
      ...
      <ul className="docs-list">
        ...
        <li className="docs-list-item">
          <span className="docs-highlight">Fully Modular:</span> Install strictly what you need, BiharUI is not a
          dependency
        </li>
        <li className="docs-list-item">
      ...
      <p className="docs-paragraph">
        BiharUI is not your classic NPM library, you install only the components you need by either copying the code or
