...
const EXAMPLE_PROMPTS = [
  'Show me all the available backgrounds from the BiharUI registry',
  'Add the Dither background from BiharUI to the page, make it purple',
  'Add a new section which fades in on scroll using FadeContent from BiharUI'
];
  ...
  return (
    <section className="docs-section">
      ...
      <p className="docs-paragraph dim">
        BiharUI encourages the use of the shadcn MCP server to browse, search, and install components using natural
        language.
      </p>
