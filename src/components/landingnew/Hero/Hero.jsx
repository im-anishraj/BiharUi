...
const SNIPPET_DEFS = [
  {
    ...
    props: [
      { name: 'color', type: 'color', default: '#D4A64A' },
  ...
  },
  {
    ...
    component: 'DotField',
    props: [
      { name: 'dotRadius', type: 'number', default: 1.2, min: 1, max: 3, step: 0.1 },
      { name: 'dotSpacing', type: 'number', default: 20, min: 10, max: 40, step: 1 },
...
const Hero = () => {
  ...
  const { accentFg, dotGradientFrom, dotGradientTo } = useMemo(() => {
    ...
    return {
      ...
      dotGradientFrom: `rgba(${ar}, ${ag}, ${ab}, 0.15)`,
      dotGradientTo: `rgba(${Math.min(ar + 12, 255)}, ${Math.min(ag + 66, 255)}, ${Math.min(ab + 16, 255)}, 0.05)`
    };
  }, [accentColor]);
      ...
      <svg className="ln-hero-bottom-fade" preserveAspectRatio="none" viewBox="0 0 1 1">
        <defs>
          <linearGradient id="hero-bottom-fade" x1="0" y1="0" x2="0" y2="1">
            ...
            <stop offset="50%" stopColor="#0B0B0F" stopOpacity="0" />
            <stop offset="60%" stopColor="#0B0B0F" stopOpacity="0.03" />
            <stop offset="68%" stopColor="#0B0B0F" stopOpacity="0.1" />
            <stop offset="74%" stopColor="#0B0B0F" stopOpacity="0.22" />
            <stop offset="80%" stopColor="#0B0B0F" stopOpacity="0.38" />
            <stop offset="85%" stopColor="#0B0B0F" stopOpacity="0.55" />
            <stop offset="90%" stopColor="#0B0B0F" stopOpacity="0.72" />
            <stop offset="94%" stopColor="#0B0B0F" stopOpacity="0.87" />
            <stop offset="97%" stopColor="#0B0B0F" stopOpacity="0.95" />
